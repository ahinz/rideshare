...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.start_readable'
        db.add_column('rideshare_trip', 'start_readable',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Trip.end_readable'
        db.add_column('rideshare_trip', 'end_readable',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Trip.start_readable'
        db.delete_column('rideshare_trip', 'start_readable')

        # Deleting field 'Trip.end_readable'
        db.delete_column('rideshare_trip', 'end_readable')
    ...
    models = {
        ...
        'rideshare.rider': {
            ...
            'trip': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rideshare.Trip']"}),
        ...
        'rideshare.trip': {
            ...
            'end_readable': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'start_readable': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {})
        },
        'rideshare.userprofile': {
