...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Trip'
        db.create_table('rideshare_trip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.contrib.gis.db.models.fields.PointField')()),
        ...
        db.send_create_signal('rideshare', ['Trip'])

        # Adding model 'Rider'
        db.create_table('rideshare_rider', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rideshare.Trip'])),
        ...
        db.send_create_signal('rideshare', ['Rider'])

    def backwards(self, orm):
        # Deleting model 'Trip'
        db.delete_table('rideshare_trip')

        # Deleting model 'Rider'
        db.delete_table('rideshare_rider')
